class Configurator_1 {
    ...
    async startConfigurate(modelId) {
        console.log("startConfigurate", modelId);
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (!this.configData.settings) {
                this.configData.settings = this.defaultSettings;
            }
    ...
    getMaterialsForRightPanel() {
        ...
        if (this.configData.settings?.getMatInfoFromConfig) {
    ...
    async startGroup(models) {
        ...
        this.sceneObjects = models.map((model) => {
            ...
            sceneObject.flipY = model.configInfo.params.flipY || false;
    ...
    async configurateNextModel() {
        console.log("---- configurateNextModel ----");
    ...
    setSceneObjectAsCurrent(sceneObject) {
        ...
        // this.initMaterials = this.sceneObject.getMaterials();
        // this.configData = await this.getConfigData(sceneObject.getProductId());
    }
    ...
    // ----- methods from advanced configurator -----
